...
export const AdminProvider = ({ children }) => {
    ...
    const updateProduct = useCallback(async (productId, productData) => {
        try {
            const res = await axiosInstance.patch(`/products/${productId}`, productData);
            return res.data;
        } catch (error) {
    ...
    const updateGalleryItem = useCallback(async (galleryId, galleryData) => {
        try {
            const res = await axiosInstance.patch(`/gallery/${galleryId}`, galleryData);
            return res.data;
        } catch (error) {
    ...
    const updateContactStatus = useCallback(async (contactId, status) => {
        try {
            const res = await axiosInstance.patch(`/contact/${contactId}`, { status });
            return res.data;
        } catch (error) {
